        ...
        <div className="md:max-w-[52%]">
          ...
          <div className="flex flex-row gap-3 justify-center md:justify-start items-center md:items-start">
            <a
              ...
              className="flex items-center justify-center gap-1.5 bg-brand-light text-white px-4 py-2 md:px-8 md:py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity text-sm md:text-lg"
            >
