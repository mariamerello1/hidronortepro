        ...
        <div className="md:max-w-[52%]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start items-center md:items-start">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-brand-light text-white px-6 py-2 sm:px-8 sm:py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity text-base sm:text-lg w-full max-w-[220px] sm:w-auto sm:max-w-none"
            >
